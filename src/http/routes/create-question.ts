...
import { generateAnswer, generateEmbeddins } from '../../services/gemini.ts'
...
export const createQuestionRoute: FastifyPluginCallbackZod = (app) => {
  app.post(
    ...
    async (request, reply) => {
      ...
      const embeddings = await generateEmbeddins(question)
      ...
      //biome-ignore lint/suspicious/noConsole: Because yes
      console.log(answer)
